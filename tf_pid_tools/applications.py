...
1. Transfer function identification: estimation of system dynamics from data.
2. PID auto-tuning: interactive adjustment and optimization of PID controllers.
